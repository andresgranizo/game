...
.mp-selection .region {
  background-color: rgba(31, 161, 93, 0.3);
}
...
.syntax--source.syntax--tsx .syntax--support.syntax--type {
  color: #b58900;
        ...
        <body class='markdown-preview' data-use-github-style><h1 id="plim-plam-plum">Plim Plam Plum</h1>
<p>The purpose of this game is to replace ...</p>
<h2 id="how-to-run">How to run?</h2>
<pre class="editor-colors lang-BASH"><div class="line"><span class="syntax--source syntax--shell"><span class="syntax--entity syntax--name syntax--function">ruby</span> lib/numbers.rb</span></div></pre>
<h2 id="running-the-test-suite">Running the test suite</h2>
<pre class="editor-colors lang-SHELL"><div class="line"><span class="syntax--source syntax--shell"><span class="syntax--entity syntax--name syntax--function">rspec</span> specs</span></div></pre></body>
      </html>
